...
(function ($) {
    ...
    var FilterMultiSelect =
        ...
        function () {
            ...
            FilterMultiSelect.prototype.initialize = function () {
                ...
                this.viewBar.className = 'viewbar ant-input ant-input-lg';
    ...
    $__default['default'].fn.filterMultiSelect = function (args) {
        ...
        if (typeof args.placeholderText === 'undefined') args.placeholderText = 'Ничего не выбрано';
        if (typeof args.filterText === 'undefined') args.filterText = 'Filter';
        if (typeof args.selectAllText === 'undefined') args.selectAllText = 'Выбрать Всё';
